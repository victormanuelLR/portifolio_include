...
export default function Projects() {
  return (
    <section id="projects">
      <h2>Projects Page</h2>
      <Card title={"InteliAr"} imageSrc={"../projects/InteliAr.jpeg"} altText={"logo InteliAR"} cardColor={"#2e9dcc"} description={"InteliAr é um projeto de monitoramento de presença humana para gerenciamento de ArCOndicionado"}/>
